...
public class RepairMapper {
    ...
    public Repair mapToRepair(RepairDto repairDto) {
    ...
    public List<RepairDto> mapToRepairDtoList(List<Repair> repairList) {
    ...
    public List<Repair> mapToRepairList(List<RepairDto> repairDtoList) {
